              ...
              <tr>
                ...
                <td>
                  @if ($role->permissions->count() > 0)
                    <span class="badge badge-info rounded "
                      data-toggle="tooltip"
                      title="This role has {{ $role->permissions->count() }} permission">{{ $role->permissions->count() }}</span>
                  @else
                    <span class="badge badge-danger"
                      data-toggle="tooltip"
                      title="No, permissions found">No</span>
                  @endif
                </td>
                ...
                <td>
                  ...
                  @if ($role->deletable == true)
                    <form action="{{ route('app.roles.destroy', $role->id) }}"
