      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ml-auto">
          <a class="btn btn-primary"
            href="{{ route('app.pages.create') }}"
            data-toggle="tooltip"
            title="Create new static page  &#9989;"><i class="bx bx-plus"></i>Add</a>
        </div>
      </div>
    </div>
    <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  @if ($page->status)
                    <span class="badge badge-info rounded "
                      data-toggle="tooltip"
                      title="Page status is true &#128077">Active</span>
                  @else
                    <span class="badge badge-danger"
                      data-toggle="tooltip"
                      title="Page status is false &#128078">Inactive</span>
                  @endif
                </td>
                ...
                <td>
                  <a class="btn btn-sm btn-info"
                    ...
                    data-toggle="tooltip"
                    title="Page details &#128065;"><i class="fadeIn animated bx bx-show"></i>
                  </a>
                  <a class="btn btn-sm btn-success"
                    href="{{ route('app.pages.edit', $page->id) }}"
                    data-toggle="tooltip"
                    title="Edit &#128221"><i class="fadeIn animated bx bx-edit"></i>
                  </a>
                  <form action="{{ route('app.pages.destroy', $page->id) }}"
