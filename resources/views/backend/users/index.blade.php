      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ml-auto">
          <a class="btn btn-primary "
            href="{{ route('app.users.create') }}" data-toggle="tooltip" title="Create new user  &#9989;"><i class="bx bx-plus mr-1"></i> Add</a>
        </div>
      </div>
    </div>
    <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-sm btn-info"
                    href="{{ route('app.users.edit', $user->id) }}"><i class="fadeIn animated bx bx-edit" data-toggle="tooltip" title="Edit &#128221"></i></a>
                  <form action="{{ route('app.users.destroy', $user->id) }}"
                    ...
                    <button class="btn btn-sm btn-danger delete-confirm"
                      type="submit" data-toggle="tooltip" title="Delete &#128683">
