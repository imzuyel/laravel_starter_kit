      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ml-auto">
          <a class="btn btn-primary px-3"
            href="{{ route('app.menus.create') }}" data-toggle="tooltip" title="Add new menu &#9989"><i class="bx bx-plus mr-1"></i>Add</a>
        </div>
      </div>
    </div>
    <div class="card-body">
            ...
            @foreach ($menus as $key => $menu)
              <tr>
                ...
                <td>
                    ...
                    href="{{ route('app.menus.builder', $menu->id) }}" data-toggle="tooltip" title="Build your own menu &#9989"><i class="fadeIn animated bx bx-menu"></i></a>
                  <a class="btn btn-sm btn-success"
                    href="{{ route('app.menus.edit', $menu->id) }}"  data-toggle="tooltip"
                    title="Edit &#128221"><i class="fadeIn animated bx bx-edit"></i></a>
                    @if ($menu->deletable)
                  <form action="{{ route('app.menus.destroy', $menu->id) }}"
